...
func newCustomer(db *gorm.DB, opts ...gen.DOOption) customer {
	...
	_customer.customerDo.UseModel(&entities.Customer{})
...
type ICustomerDo interface {
	...
	Create(values ...*entities.Customer) error
	CreateInBatches(values []*entities.Customer, batchSize int) error
	Save(values ...*entities.Customer) error
	First() (*entities.Customer, error)
	Take() (*entities.Customer, error)
	Last() (*entities.Customer, error)
	Find() ([]*entities.Customer, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entities.Customer, err error)
	FindInBatches(result *[]*entities.Customer, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*entities.Customer) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*entities.Customer, error)
	FirstOrCreate() (*entities.Customer, error)
	FindByPage(offset int, limit int) (result []*entities.Customer, count int64, err error)
...
func (c customerDo) Create(values ...*entities.Customer) error {
	if len(values) == 0 {
		return nil
	}
...
func (c customerDo) CreateInBatches(values []*entities.Customer, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c customerDo) Save(values ...*entities.Customer) error {
	if len(values) == 0 {
		return nil
	}
...
func (c customerDo) First() (*entities.Customer, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*entities.Customer), nil
	}
}

func (c customerDo) Take() (*entities.Customer, error) {
...
func (c customerDo) Last() (*entities.Customer, error) {
...
func (c customerDo) Find() ([]*entities.Customer, error) {
	result, err := c.DO.Find()
	return result.([]*entities.Customer), err
}

func (c customerDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entities.Customer, err error) {
	buf := make([]*entities.Customer, 0, batchSize)
...
func (c customerDo) FindInBatches(result *[]*entities.Customer, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c customerDo) FirstOrInit() (*entities.Customer, error) {
...
func (c customerDo) FirstOrCreate() (*entities.Customer, error) {
...
func (c customerDo) FindByPage(offset int, limit int) (result []*entities.Customer, count int64, err error) {
...
func (c customerDo) Delete(models ...*entities.Customer) (result gen.ResultInfo, err error) {
